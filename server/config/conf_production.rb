...
DELIVERY_SITE_TYPES = [
    ...
    {:id => '[F] M1 2C', :name => '[F] M1 2C', :environments => ['FAT', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 0},
    {:id => '[F] T7 1C', :name => '[F] T7 1C', :environments => ['FAT', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 0},

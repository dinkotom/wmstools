...
PROMETERA_PERFORMANCE_TESTS_JOB = {
    ...
    :suites_environments =>
        [
            #{:suite => '[P] PERFORMANCE TESTS 1 [for FF]', :environment => 'PROMETERA'},
            #{:suite => '[P] PERFORMANCE TESTS 2 [for FF]', :environment => 'PROMETERA'},
            #{:suite => '[P] PERFORMANCE TESTS 3 [for FF]', :environment => 'PROMETERA'},
            {:suite => '[P] PERFORMANCE TESTS 4 [for IE]', :environment => 'PROMETERA'},
            {:suite => '[P] PERFORMANCE TESTS 5 [for IE]', :environment => 'PROMETERA'},
        ]
}
...
DELIVERY_SITE_TYPES = [
    ...
    {:id => '[H] AMS Z31 1c', :name => '[H] AMS Z31 1c', :environments => ['DEVHF02'], :test_suite_name => '[H] BUFFER TESTS', :quota => 0},
    {:id => '[H] AMS Z31 2c', :name => '[H] AMS Z31 2c', :environments => ['DEVHF02'], :test_suite_name => '[H] BUFFER TESTS', :quota => 0},
	{:id => '[H] AMS Z32 1c', :name => '[H] AMS Z32 1c', :environments => ['DEVHF02'], :test_suite_name => '[H] BUFFER TESTS', :quota => 0},
]

...
TEST_SUITES = [
    ...
    {:name => '[F] REGRESSION TESTS 7', :type => 'Suite', :environments => ['FAT', 'FAT4', 'FAT5'], :piazza => true, :default_number_of_tests => 15, :priority => 9, :soapui_project_file => 'WMS.xml'},
    ...
    {:name => '[P] PERFORMANCE TESTS 1 [for FF]', :type => 'Suite', :environments => ['DEV8PROM'], :piazza => false, :default_number_of_tests => 1, :priority => 12, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    {:name => '[P] PERFORMANCE TESTS 2 [for FF]', :type => 'Suite', :environments => ['DEV8PROM'], :piazza => false, :default_number_of_tests => 1, :priority => 13, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    {:name => '[P] PERFORMANCE TESTS 3 [for FF]', :type => 'Suite', :environments => ['DEV8PROM'], :piazza => false, :default_number_of_tests => 1, :priority => 14, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    {:name => '[P] PERFORMANCE TESTS 4 [for IE]', :type => 'Suite', :environments => ['DEV8PROM'], :piazza => false, :default_number_of_tests => 1, :priority => 14, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    {:name => '[P] PERFORMANCE TESTS 5 [for IE]', :type => 'Suite', :environments => ['DEV8PROM'], :piazza => false, :default_number_of_tests => 1, :priority => 14, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    {:name => '[P] PERFORMANCE TESTS 01 [DEV8]', :type => 'Suite', :environments => ['DEV8PROM'], :piazza => false, :default_number_of_tests => 1, :priority => 14, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    {:name => '[P] PERFORMANCE TESTS 01 [PROM PERF]', :type => 'Suite', :environments => ['PROM_PERF'], :piazza => false, :default_number_of_tests => 1, :priority => 14, :soapui_project_file => 'PrometeraPerformanceGUITest-soapui-project.xml', :performance => true},
    ...
    {:name => '[S] RT7 [TERMINATION]', :type => 'Suite', :environments => ['DEV2SKA'], :piazza => false, :default_number_of_tests => 8, :priority => 31, :soapui_project_file => 'SKAGERAK-REST-soapui-project.xml'},
    {:name => '[S] RT8 [ADD DOCUMENT]', :type => 'Suite', :environments => ['DEV2SKA'], :piazza => false, :default_number_of_tests => 8, :priority => 31, :soapui_project_file => 'SKAGERAK-REST-soapui-project.xml'},
    ...
    {:name => '[H] REGRESSION TESTS 1', :type => 'Suite', :environments => ['DEVHF02'], :piazza => true, :default_number_of_tests => 4, :priority => 25, :soapui_project_file => 'WMS-AMS.xml'},
	{:name => '[H] REGRESSION TESTS 2', :type => 'Suite', :environments => ['DEVHF02'], :piazza => true, :default_number_of_tests => 10, :priority => 26, :soapui_project_file => 'WMS-AMS.xml'},
...
ENVIRONMENTS = [
    ...
    {:name => 'FAT', :wms_version => '5.0.0'},
    {:name => 'DEV1', :wms_version => '4.8.2DEV'},
    {:name => 'DEV8PROM', :wms_version => '5.0.0'},
    {:name => 'PROM_PERF', :wms_version => '5.0.0'},
    {:name => 'DEV2SKA', :wms_version => '5.0.0'},
    {:name => 'DEV7', :wms_version => '5.0.0'},
    {:name => 'DEVHF02', :wms_version => '5.0.0'},

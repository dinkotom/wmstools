...
TEST_SUITES = [
  ...
  {:name => '[F] REGRESSION TESTS 9', :type => 'Suite', :environments => ['FAT', 'FAT4', 'FAT12'], :piazza => true, :default_number_of_tests => 5, :priority => 110, :project_file => 'Fortum_regression_benkepet.xml'},
